            ...
            <CardContent className="flex flex-col gap-5 pb-5">
              ...
              <div className="flex flex-col gap-2.5">
                ...
                <div className="ml-9 flex flex-col gap-1.5">
                  <CodeBlock code="curl -fsSL /api/network/node-script/launcher -o start-node.sh && bash start-node.sh" />
                  <p className="text-[11px] text-white/35">
                    The launcher is generated by this server — the coordinator address is already baked in.
                    Add <code className="font-mono text-white/50">--label my-node</code> to give your node a name.
                  </p>
                </div>
              </div>
